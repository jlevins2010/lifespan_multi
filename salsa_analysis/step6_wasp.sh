...
contigdir=/home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/contig/$library_id
wasp=/opt/WASP
workdir=/home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/bcfilter_atac/find_intersecting_snps_${library_id}
mkdir -p $workdir
...
if [ $isphased = "true" ]; then
  ...
  rm /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/haplotypes.h5 /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/snp_index.h5 /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/snp_tab.h5 /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/haplotype.chr*.vcf.gz 2> /dev/null
  for contig in ${contigs[@]}; do
    echo "Subsetting vcf for $contig"
    bcftools view -Oz $inputvcf $contig -o /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/haplotype.$contig.vcf.gz
  done
  # create snp hdf5 file
  echo "Generating snp hdf5"
  $wasp/snp2h5/snp2h5 \
    --chrom //home/levinsj/Applications/hg38_chromInfo.txt.gz \
    --format vcf \
    --haplotype /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/haplotypes.h5 \
    --snp_index /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/snp_index.h5 \
    --snp_tab   /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/snp_tab.h5 \
      /home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/haplotype.chr*.vcf.gz
...
if [ $isphased = "false" ]; then
  ...
  contigdir=/home/levinsj/MultiOme/Analysis/SALSA/WASP_ATAC/vcf
