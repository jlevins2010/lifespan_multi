...
input_file = "/home/levinsj/MultiOme/ATAC_data/Human/04_SCVI/post_SCVI_clean2.h5ad"
peakVI_model = "/home/levinsj/MultiOme/scvi_Models/all_snATAC_with_doublets_postfirstclean_human/"
output_file = "/home/levinsj/MultiOme/ATAC_data/Human/04_SCVI/postSCVI_ATAC_postclean2.h5ad"
barcodes_output_file = "/home/levinsj/MultiOme/Barcodes/snapATAC_Barcodes/postPeakVI_barcodes_human.csv"
...
bad_clusters.append(["4",'23','24','28'])
...
index_df = pd.DataFrame({"cell_name": adata.obs_names, "peakVI_cluster": adata.obs["clusters_peakvi"], "sample": adata.obs["sample"]})

index_df.to_csv(barcodes_output_file, index=False, header=True)  
