...
model = scvi.model.MULTIVI.load("/home/levinsj/MultiOme/scvi_Models/peakVI_temp/", adata) 
...
model = scvi.model.MULTIVI.load(peakVI_model, adata)  # Load, providing the same AnnData
